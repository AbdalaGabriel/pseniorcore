...
class MailController extends Controller
{
    ...
    public function basic_email(){
        ...
        Mail::send(['text'=>'mail'], $data, function($message){
            $message->to('g.abdala.04@gmail.com','Harison Matondang')->subject('Send Mail from Laravel with Basics Email');
    ...
    public function html_email(){
      $data=['name'=>'Harison matondang'];
      Mail::send(['text'=>'mail'], $data, function($message){
          $message->to('g.abdala.04@gmail.com@gmail.com','Harison Matondang')->subject('Send Mail from Laravel with HTML Email');
          $message->from('nabilaauliaputri29@gmail.com','Nabila');
      });
