...
function carga()
{
	...
	var route = baseurl+"admin/tutoriales-y-recursos-tags";
	tablaDatos = $("#datos");
...
function defineListerner()
{
    ...
    $("#createCategory").click(function()
    {
        ...
        route = baseurl+"admin/tutoriales-y-recursos-tags";
        token = $("#token").val();
    ...
    $(".delete").on("click", function()
    {
        ...
        route = baseurl+"admin/tutoriales-y-recursos-tags/"+idDeleteButton;
        token = $("#token").val();
