		...
		$(res).each(function(key, value)
		{
			if(value.visible_in_menu == 1)
			{
				if(value.can_be_deleted == 0){
					tablaDatos.append('<tr><td>'+value.title+'<br/><a href="#" class="quickEdit" data-toggle="modal" data-target="#quickedit-modal" data-id="'+value.id+'">Quick Edit</a></td> <td>'+value.urlfriendly+'</td><td><a href="/admin/paginas/en/'+value.id+'/edit" data-id="'+value.id+'">Versión en inglés</a></td><td><a href="'+baseurl+'admin/paginas/'+value.id+'/edit" data-id="'+value.id+'">Editar</a></td><td>-</td></tr>');
