...
<body class="intern">
	...
	<nav class="hidden-menu">
		...
		<ul>
			...
			<li>
				{!! link_to_action('FrontController@blog','Blog') !!}
			</li>
			<li>
			...
			<li>
				{!! link_to_action('FrontController@contact','Contact') !!}
...
<!-- footer -->
			<section class="g-section no-padding contact">
				<div class="section-container  col-md-4 tuts">
						...
						<h3>Open access to tutorials and multimedia resources, open to the community</h3>
				</div>

				<div class="section-container  col-md-4 org">
					<h2>Organize your projects</h2>
					<h3>Register as a free user and access the exclusive organizer for customers</h3>
					<h4>Together we can make greath things!</h4>

					<a href="#" class="register g-button">Register</a>
					<a href="#">Why to register?</a>
				</div>
					...
					<div id="mc_embed_signup">
						<form action="//twitter.us14.list-manage.com/subscribe/post?u=21939b15fd9aeae487bd56ef1&amp;id=a5ecdc5c4a" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
							<div id="mc_embed_signup_scroll">
								...
								<div class="indicates-required"><span class="asterisk">*</span> obligatory</div>
