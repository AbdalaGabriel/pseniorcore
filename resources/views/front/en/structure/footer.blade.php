<footer>	
	...
	<div class="engagement-container">	
				<h2>¿Are you ready to start a new project together?</h2>
				<a href="/en/contact-me" class="contact">Let's get in touch</a>
		</div>
...
<noscript>Please enable Javascript to see the email address</noscript></span>
		...
		<div class="footer-box contact-me">
			...
			@if (Auth::guest())
				...
				<a class="footer-links" href="#newsletterWp">Suscribe to newsletter</a>
				<a class="footer-links" href="/register">Register</a>
				
			@else
				
				<a class="footer-links" target="_blank" href="/organizer/{!!Auth::user()->id!!}">My organizer</a>
				<a target="_blank" class="footer-links" href="http://twitter.us14.list-manage.com/unsubscribe?u=21939b15fd9aeae487bd56ef1&id=a5ecdc5c4a">Unsuscribe me from newsletter</a>
				<!--<a class="footer-links" href="/register">Panel de usuario</a>-->
				<a class="footer-links" href="/logout">Logout</a>
			@endif

			<a target="_blank" href="http://www.defensaconsumidor.gba.gov.ar/" class="footer-links">Customer deffense</a>
		...
		<div class="brand-footer-container">
			<div class="signature-container">
				<div class="signature">
					...
					<span class="slogan">At service, always</span>
			</div>
