	<!-- footer -->
			<section class="g-section no-padding contact pre-footer">
				...
				<div class="qr-container">
					<img class="qr" src="/img/front/qr.jpg" alt="Codigo qr">
				</div>
				</a>
...
<script type='text/javascript' src='//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js'></script><script type='text/javascript'>(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[1]='FNAME';ftypes[1]='text';fnames[0]='EMAIL';ftypes[0]='email';fnames[3]='MMERGE3';ftypes[3]='dropdown'; /*
